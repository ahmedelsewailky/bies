                ...
                <div class="col-md-7">
                    <form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-9">
                                <select id="year" name="year" class="form-control @error('year') is-invalid @enderror">
                                    ...
                                    @for ($i = date('Y'); $i >= 1900; $i--)
                                        <option value="{{ $i }}" {{ old('year') == $i ? 'selected' : false }}>{{ $i }}</option>
                                    @endfor
                                </select>
                                @error('year')
                                    <p class="invalid-feedback">{{ $message }}</p>
                            ...
                            <div class="col-md-9">
                                <select id="quality" name="quality" class="form-control @error('quality') is-invalid @enderror">
                                    ...
                                    @foreach (DataArray::QUALITIES as $key => $value)
                                        <option value="{{ $key }}"  {{ old('quality') == $key ? 'selected' : false }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                                @error('quality')
                                    <p class="invalid-feedback">{{ $message }}</p>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="link_1" name="links[]" class="form-control mb-3 @error('links') is-invalid @enderror" placeholder="رابط التحميل الأول">
                                <input type="text" id="link_2" name="links[]" class="form-control mb-3 @error('links') is-invalid @enderror" placeholder="رابط التحميل الثاني">
                                <input type="text" id="link_3" name="links[]" class="form-control mb-3 @error('links') is-invalid @enderror" placeholder="رابط التحميل الثالث">
                                <input type="text" id="link_4" name="links[]" class="form-control mb-3 @error('links') is-invalid @enderror" placeholder="رابط التحميل الرابع">
                                <input type="text" id="link_5" name="links[]" class="form-control mb-3 @error('links') is-invalid @enderror" placeholder="رابط التحميل الخامس">
                                @error('links')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="watchLink" name="watch_link" class="form-control mb-3 @error('watch_link') is-invalid @enderror" placeholder="رابط المشاهدة المباشرة">
                                @error('watch_link')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
